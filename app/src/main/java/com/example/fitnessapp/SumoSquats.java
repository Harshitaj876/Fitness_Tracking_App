...
public class SumoSquats extends AppCompatActivity {
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sumo_squats);
        ...
        btnStop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                float caloriePerSecond = 0.1166f; // assume burning 10 calories per minute
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SumoSquats.this, ExploreActivity.class);
