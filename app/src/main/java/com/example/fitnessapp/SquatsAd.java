...
public class SquatsAd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_squats_ad);

        backbtn8 = findViewById(R.id.backbtn8);
        backbtn8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SquatsAd.this, jumpingjacks.class);
        ...
        linear.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SquatsAd.this, LegPressad.class);
                startActivity(intent);
            }
        });
        ...
        btnStop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                float caloriePerSecond = 0.133f; // assume burning 10 calories per minute
